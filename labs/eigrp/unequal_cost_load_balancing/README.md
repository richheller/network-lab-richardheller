...
<br><i>To use this lab, import the topology.yaml file into Cisco Modeling Labs</i>

<h1>EIGRP - Unequal Cost Load Balancing</h1>

# Overview

EIGRP is an advanced distance vector routing protocol, originally Cisco proprietary. For this lab I built the topology from scratch in Cisco Modeling Labs (CML) on a dedicated server I host.
...
> <b>Applying a variance of 7 to allow all three feasible paths to be installed into the routing table.</b>
<br>
<img width="534" height="128" alt="image" src="https://github.com/user-attachments/assets/b0f81ca7-837f-449a-8ba3-60640ee6d389" />

This lab shows how you can actually control path selection in EIGRP and allow multiple routes to be installed even when they aren't equal cost. Traffic is now distributed proportionally across paths based on the metric.
